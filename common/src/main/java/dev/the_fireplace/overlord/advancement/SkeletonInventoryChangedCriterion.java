...
public class SkeletonInventoryChangedCriterion extends SimpleCriterionTrigger<SkeletonInventoryChangedCriterion.Conditions>
{
    ...
    public static class Conditions extends AbstractCriterionTriggerInstance
    {
        ...
        public Conditions(EntityPredicate.Composite player, MinMaxBounds.Ints occupied, MinMaxBounds.Ints full, MinMaxBounds.Ints empty, EquipmentSlotItemPredicate[] itemPredicates) {
            super(ID, player);
        ...
        public static Conditions items(EquipmentSlotItemPredicate... items) {
            return new Conditions(EntityPredicate.Composite.ANY, MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, items);
        }
        ...
        public static Conditions items(ItemLike... items) {
            ...
            for (int i = 0; i < items.length; ++i) {
                itemPredicates[i] = new EquipmentSlotItemPredicate(null, ImmutableSet.of(items[i].asItem()), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, EnchantmentPredicate.NONE, EnchantmentPredicate.NONE, null, NbtPredicate.ANY, null);
            }
