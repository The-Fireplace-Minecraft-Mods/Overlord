...
{
    private static final String TRANSLATION_BASE = "gui." + OverlordConstants.MODID + ".aisettings.";
    ...
    public SkeletonOrdersGuiFactory(
        ...
        UpdateOrdersBufferBuilder updateOrdersBufferBuilder
    ) {
    ...
    public Screen build(Screen parent, OrderableEntity aiEntity) {
        ...
        this.currentPosition = aiEntity instanceof Entity ? new BlockPos(((Entity) aiEntity).position()) : null;
	...
	private void buildCategories(AISettings currentSettings) {
        ...
        if (loaderHelper.isDevelopmentEnvironment()) {
