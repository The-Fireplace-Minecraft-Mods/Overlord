...
public final class ItemDropperImpl implements ItemDropper {
    ...
    public ItemEntity throwItem(ItemStack stack, LivingEntity entity) {
        ...
        float g = Mth.sin(entity.getXRot() * (float) Math.PI / 180);
        float j = Mth.cos(entity.getXRot() * (float) Math.PI / 180);
        float k = Mth.sin(entity.getYRot() * (float) Math.PI / 180);
        float l = Mth.cos(entity.getYRot() * (float) Math.PI / 180);
