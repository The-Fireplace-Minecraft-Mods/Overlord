...
public final class SquadsImpl implements Squads
{
    ...
    @Override
    public Squad createNewSquad(UUID owner, ResourceLocation patternId, ItemStack stack, String name) {
    ...
    private class SavedSquad implements Squad, SaveData
    {
        ...
        private SavedSquad(UUID id, UUID owner) {
            this.id = id;
            this.owner = owner;
            this.patternId = new ResourceLocation("");
        ...
        public void readFrom(StorageReadBuffer buffer) {
            ...
            if (!legacyPattern.isEmpty()) {
                //TODO 4.0.0 eliminate legacy checking
                this.patternId = new ResourceLocation(OverlordConstants.MODID, legacyPattern);
            } else {
                this.patternId = new ResourceLocation(buffer.readString("patternId", ""));
            }
            try {
                this.item = ItemStack.of(TagParser.parseTag(buffer.readString("item", "")));
        ...
        public void writeTo(StorageWriteBuffer buffer) {
            ...
            buffer.writeString("item", item.save(new CompoundTag()).toString());
