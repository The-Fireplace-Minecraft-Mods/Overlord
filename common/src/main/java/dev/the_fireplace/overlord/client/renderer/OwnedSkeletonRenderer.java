...
public class OwnedSkeletonRenderer extends HumanoidMobRenderer<OwnedSkeletonEntity, OwnedSkeletonModel>
{
    ...
    public OwnedSkeletonRenderer(EntityRenderDispatcher context) {
        super(context, new OwnedSkeletonModel(false, false, false), 0.5F);
        ...
        HumanoidModel<OwnedSkeletonEntity> bodyModel = new HumanoidModel<>(1);
        ...
        this.addLayer(new AugmentHeadFeatureRenderer<>(this));
        this.addLayer(new SquadCapeFeatureRenderer<>(this));
        this.addLayer(new SquadElytraFeatureRenderer<>(this));
    ...
    private void cacheSkinsuitTexture(OwnedSkeletonEntity entity) {
        ...
        if (!skinCache.containsKey(skinsuit)) {
            ...
            ClientboundPlayerInfoPacket dummyPlayerListPacket = new ClientboundPlayerInfoPacket();
            skinCache.put(skinsuit, new PlayerInfo(dummyPlayerListPacket.new PlayerUpdate(
                gameProfile,
                0,
                GameType.SURVIVAL,
                null
