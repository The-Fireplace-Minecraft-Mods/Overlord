...
public class LocalOrdersScreen extends Screen
{
    ...
    protected void init() {
        ...
        //x, y, width, height
        addButton(new Button(width / 2 - 50, height / 2, 100, 20, new TranslatableComponent("gui.overlord.orders"), openOrdersScreen));
        addButton(new Button(width / 2 - 50, height / 2 + 22, 100, 20, new TranslatableComponent("gui.overlord.select_squad"), (b) -> screenOpener.openSquadSelectorGUI(null)));
        addButton(new Button(width / 2 - 102, height / 2 + 44, 100, 20, new TranslatableComponent("gui.overlord.local_orders.issue_orders"), this::issueOrders));
        addButton(new Button(width / 2 + 2, height / 2 + 44, 100, 20, new TranslatableComponent("gui.done"), (b) -> this.closeScreen()));
    }
