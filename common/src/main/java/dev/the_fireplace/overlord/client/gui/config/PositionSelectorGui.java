...
public class PositionSelectorGui extends Screen implements CustomButtonScreen<String>
{
    ...
    protected void init() {
        ...
        this.addButton(xWidget = new EditBox(minecraft.font, this.width / 2 - 75 - 2, this.height / 2, 50, 20, "X"));
        this.addButton(yWidget = new EditBox(minecraft.font, this.width / 2 - 25, this.height / 2, 50, 20, "Y"));
        this.addButton(zWidget = new EditBox(minecraft.font, this.width / 2 + 25 + 2, this.height / 2, 50, 20, "Z"));
        Button currentPositionButton = new Button(this.width / 2 - 100, this.height / 2 - 30, 200, 20, I18n.get("gui.overlord.select_position.use_current"), (button) -> {
            setCoordinates(currentPosition.getX(), currentPosition.getY(), currentPosition.getZ());
        });
        this.addButton(currentPositionButton);
        this.addButton(confirmButton = new Button(this.width / 2 - 202, this.height - 30, 200, 20, I18n.get("gui.overlord.confirm_exit"), (button) -> {
        ...
        this.addButton(new Button(this.width / 2 + 2, this.height - 30, 200, 20, I18n.get("gui.cancel"), (button) -> {
