...
public class PositionSelectorGui extends Screen implements CustomButtonScreen<String>
{
    ...
    protected void init() {
        ...
        this.addButton(xWidget = new EditBox(minecraft.font, this.width / 2 - 75 - 2, this.height / 2, 50, 20, Component.nullToEmpty("X")));
        this.addButton(yWidget = new EditBox(minecraft.font, this.width / 2 - 25, this.height / 2, 50, 20, Component.nullToEmpty("Y")));
        this.addButton(zWidget = new EditBox(minecraft.font, this.width / 2 + 25 + 2, this.height / 2, 50, 20, Component.nullToEmpty("Z")));
        ...
        this.addButton(confirmButton = new Button(this.width / 2 - 202, this.height - 30, 200, 20, new TranslatableComponent("gui.overlord.confirm_exit"), (button) -> {
