...
public class ListBuilderGui extends Screen implements CustomButtonScreen<String>
{
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 202, this.height - 30, 200, 20, "Confirm and exit", (button) -> {
            onClose();
        }));
        this.addButton(new Button(this.width / 2 + 2, this.height - 30, 200, 20, "Cancel", (button) -> {
