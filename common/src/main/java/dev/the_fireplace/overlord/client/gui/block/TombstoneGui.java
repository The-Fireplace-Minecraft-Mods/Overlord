...
public class TombstoneGui extends Screen
{
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120, 200, 20, I18n.get("gui.done"), (buttonWidget) -> {
            this.finishEditing();
        }));
        this.selectionManager = new TextFieldHelper(
            ...
            Math.max(90, this.minecraft.font.width("wWwWwWwWwWwWwWwW"))
        );
    }
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        drawCenteredString(this.font, this.title.getContents(), this.width / 2, 40, textColor);
        ...
        if (!string.isEmpty() && selectionStart >= 0) {
            ...
            if (isCursorVisible && selectionStart < string.length()) {
                int var34 = cursorY - 1;
                int var10003 = u + 1;
                fill(u, var34, var10003, cursorY + 9, -16777216 | textColor);
            }
