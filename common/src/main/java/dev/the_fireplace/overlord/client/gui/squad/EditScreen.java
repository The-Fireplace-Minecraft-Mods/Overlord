...
{
    private static final String SQUAD_NAME_FIELD_TITLE = I18n.get("gui.overlord.create_squad.squad_name");
    ...
    protected void init() {
        ...
        confirmButton = new Button(this.width / 2 - 202, this.height - 30, 200, 20, I18n.get("gui.overlord.confirm_exit"), confirmAction);
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.font.draw(SQUAD_NAME_FIELD_TITLE, this.width * 3f / 4f - font.width(SQUAD_NAME_FIELD_TITLE) / 2f, 4, 0xFFFFFF);
    }
