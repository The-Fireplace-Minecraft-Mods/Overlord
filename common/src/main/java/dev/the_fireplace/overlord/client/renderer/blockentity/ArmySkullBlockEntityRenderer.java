...
public class ArmySkullBlockEntityRenderer implements BlockEntityRenderer<ArmySkullBlockEntity>
{
    ...
    public static void renderSkull(@Nullable Direction direction, int overlay, float yaw, float animationProgress, PoseStack matrices, MultiBufferSource vertexConsumers, int light, SkullModelBase model, RenderType renderLayer) {
        matrices.pushPose();
        if (direction == null) {
