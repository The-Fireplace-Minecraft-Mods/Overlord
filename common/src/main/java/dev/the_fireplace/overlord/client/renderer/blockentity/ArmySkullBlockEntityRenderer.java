...
public class ArmySkullBlockEntityRenderer extends BlockEntityRenderer<ArmySkullBlockEntity>
{
    ...
    public static Map<AbstractArmySkullBlock.SkullType, SkullModel> getModels() {
        ImmutableMap.Builder<AbstractArmySkullBlock.SkullType, SkullModel> builder = ImmutableMap.builder();
    ...
    public ArmySkullBlockEntityRenderer(BlockEntityRenderDispatcher dispatcher) {
        super(dispatcher);
    ...
    public void render(ArmySkullBlockEntity skullBlockEntity, float f, PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i, int j) {
        ...
        SkullModel skullBlockEntityModel = this.MODELS.get(skullType);
    ...
    public static void renderSkull(Direction direction, int overlay, float yaw, float animationProgress, PoseStack matrices, MultiBufferSource vertexConsumers, int light, SkullModel model, RenderType renderLayer) {
        matrices.pushPose();
        if (direction == null) {
    ...
    public static RenderType getRenderLayer(AbstractArmySkullBlock.SkullType type) {
        ...
        return RenderType.entityCutoutNoCull(identifier);
    }
}
