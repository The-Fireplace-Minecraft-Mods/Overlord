...
public class SelectorScreen extends Screen
{
    ...
    protected void init() {
        ...
        this.addWidget(selectorWidget);
        this.addButton(new Button(this.width / 2 - 202, this.height - 30, 200, 20, new TranslatableComponent("gui.overlord.confirm_exit"), (button) -> {
            if (entityId != null) {
        ...
        this.addButton(editButton = new OverlayButtonWidget(0, this.height - 54, this.width / 3, 20, Component.nullToEmpty(""), (button) -> {
        ...
        this.addButton(deleteButton = new Button(this.width - 102, 2, 100, 20, new TranslatableComponent("gui.overlord.squad_manager.delete_squad"), (button) -> {
    ...
    public void render(PoseStack matrixStack, int mouseX, int mouseY, float delta) {
        ...
        for (GuiEventListener child : children) {
            ...
            if (!buttons.contains(child) && child instanceof Widget) {
                ((Widget) child).render(matrixStack, mouseX, mouseY, delta);
            }
        }
