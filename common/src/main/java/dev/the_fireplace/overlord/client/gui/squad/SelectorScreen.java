...
public class SelectorScreen extends Screen
{
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 202, this.height - 30, 200, 20, I18n.get("gui.overlord.confirm_exit"), (button) -> {
            if (entityId != null) {
        ...
        this.addButton(editButton = new Button(0, this.height - 54, this.width / 3, 20, "", (button) -> {
        ...
        this.addButton(deleteButton = new Button(this.width - 102, 2, 100, 20, I18n.get("gui.overlord.squad_manager.delete_squad"), (button) -> {
    ...
    private void updateButtons() {
        if (editButton != null) {
            editButton.setMessage(!emptyUUID.is(selectedSquad)
                ? I18n.get("gui.overlord.squad_manager.edit_squad")
                : I18n.get("gui.overlord.squad_manager.create_squad")
            );
        }
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        for (GuiEventListener child : children) {
            ...
            if (!buttons.contains(child) && child instanceof Widget) {
                ((Widget) child).render(mouseX, mouseY, delta);
            }
        }
