...
public final class EquipmentUtils
{
    public static boolean isMeleeWeapon(ItemStack stack) {
        return (stack.getAttributeModifiers(EquipmentSlot.MAINHAND).containsKey(SharedMonsterAttributes.ATTACK_DAMAGE.getName()) || getEnchantmentDamageModifier(stack) > 0) && !isRangedWeapon(stack);
    }
