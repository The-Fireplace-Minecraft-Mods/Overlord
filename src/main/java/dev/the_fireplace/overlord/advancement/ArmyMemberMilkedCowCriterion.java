...
public class ArmyMemberMilkedCowCriterion extends AbstractCriterion<ArmyMemberMilkedCowCriterion.Conditions>
{
    public static final Identifier ID = new Identifier(Overlord.MODID, "army_member_gathered_milk");
    ...
    public static class Conditions extends AbstractCriterionConditions
    {
        ...
        public static Conditions of(EntityType<? extends ArmyEntity> entityType) {
            return new Conditions(EntityPredicate.Extended.EMPTY, entityType);
        }
