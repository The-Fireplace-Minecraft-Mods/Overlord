...
public final class ServerToClientPacketIDs
{
    ...
    public static final Identifier OPEN_LOCAL_ORDERS_GUI = new Identifier(Overlord.MODID, "open_local_orders_gui");
    ...
    public static final Identifier SQUAD_UPDATE_FAILED = new Identifier(Overlord.MODID, "squad_update_failed");
}
