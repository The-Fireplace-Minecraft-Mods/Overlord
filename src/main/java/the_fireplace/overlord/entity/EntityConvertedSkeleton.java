...
import the_fireplace.overlord.tools.BPTools;
...
public class EntityConvertedSkeleton extends EntityArmyMember {
    ...
    protected EntityArrow getArrow(float distanceFactor)
    {
        ...
        if(itemstack != null)
            if (itemstack.getItem() == Items.SPECTRAL_ARROW)
            {
                ...
                return BPTools.setEnchantEffects(entityspectralarrow, this, distanceFactor);
            }
            else
            {
                ...
                return BPTools.setEnchantEffects(entityarrow, this, distanceFactor);
            }
        return null;
    }
    ...
    public boolean shouldMobAttack(@Nonnull EntityLiving mob) {
        return this.hasSkinsuit() && (getItemStackFromSlot(EntityEquipmentSlot.HEAD) == null || getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() != Items.SKULL || getItemStackFromSlot(EntityEquipmentSlot.HEAD).getMetadata() == 3);
    }
}
