...
public class ItemBabySpawner extends Item {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (worldIn.isRemote) {
			...
			EntityBabySkeleton entity = new EntityBabySkeleton(worldIn, playerIn.getUniqueID());
	...
	public static void applyItemEntityDataToEntity(World entityWorld, @Nullable EntityPlayer player, ItemStack stack, @Nullable EntityBabySkeleton targetEntity) {
