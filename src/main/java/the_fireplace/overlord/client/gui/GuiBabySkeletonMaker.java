...
public class GuiBabySkeletonMaker extends GuiContainer {
    ...
    private boolean isButtonEnabled() {
        return !(te.getStackInSlot(1) == null || te.getStackInSlot(2) == null) && MilkRegistry.getInstance().isMilk(te.getStackInSlot(2)) && te.getStackInSlot(1).stackSize >= ConfigValues.SERVER_BONEREQ_BABY;
    }
