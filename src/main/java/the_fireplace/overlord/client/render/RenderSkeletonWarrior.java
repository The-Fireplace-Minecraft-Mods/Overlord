...
public class RenderSkeletonWarrior extends RenderBiped<EntitySkeletonWarrior>
{
    ...
    public void doRender(@Nonnull EntitySkeletonWarrior entitySkeletonWarrior, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        //Render item
        if(entityItem == null) {
            entityItem = new EntityItem(entitySkeletonWarrior.world, x, y + entitySkeletonWarrior.height + 0.25F, z, entitySkeletonWarrior.getAugmentDisplayStack());
            entityItem.setNoDespawn();
        }
        entityItem.setLocationAndAngles(x, y+entitySkeletonWarrior.height+0.25F, z, 0, 0);
        entityItem.setEntityItemStack(entitySkeletonWarrior.getAugmentDisplayStack());
        ...
        GlStateManager.translate(0, entitySkeletonWarrior.height+0.1F, 0);
