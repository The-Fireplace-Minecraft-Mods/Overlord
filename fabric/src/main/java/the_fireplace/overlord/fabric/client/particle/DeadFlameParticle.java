package the_fireplace.overlord.fabric.client.particle;
...
public class DeadFlameParticle extends SpriteBillboardParticle {
    private DeadFlameParticle(World world, double x, double y, double z, double d, double e, double f) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, World world, double d, double e, double f, double g, double h, double i) {
            DeadFlameParticle deadFlameParticle = new DeadFlameParticle(world, d, e, f, g, h, i);
