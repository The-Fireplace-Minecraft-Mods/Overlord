...
public final class FabricEntityLoaderHelper implements EntityLoaderHelper
{
    ...
    @Override
    public void registerOwnedSkeletonMenuType() {
        ContainerProviderRegistry.INSTANCE.registerFactory(OverlordEntities.OWNED_SKELETON_ID, (syncId, identifier, player, buf) -> {
